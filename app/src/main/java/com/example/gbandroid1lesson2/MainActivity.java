...
public class MainActivity extends AppCompatActivity {
    ...
    public void button_equal(View view){
        switch (Casess){
            case 1:calc=Double.parseDouble(calcMemo1)+Double.parseDouble(calcMemo2);
                break;
            case 2:calc=Double.parseDouble(calcMemo1)-Double.parseDouble(calcMemo2);
                break;
            case 3:calc=Double.parseDouble(calcMemo1)*Double.parseDouble(calcMemo2);
                break;
            case 4:calc=Double.parseDouble(calcMemo1)/Double.parseDouble(calcMemo2);
                break;
        }
        calcMemo1="";
        ResultTextView();
